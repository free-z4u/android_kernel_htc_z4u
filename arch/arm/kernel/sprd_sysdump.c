	...
	struct pt_regs *regs)
{
	...
	/* If the default head address has not been initialized correctly, remap the head address. */
	/* NOTE: the remap will be failed, if panic occurrs in interrupt context */
