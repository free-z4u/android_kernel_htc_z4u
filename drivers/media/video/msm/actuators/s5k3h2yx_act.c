...
static int32_t s5k3h2yx_poweron_af(void)
{
	...
	mdelay(1);
#if ((defined CONFIG_CPLD) && ((defined CONFIG_MACH_DUMMY) || (defined CONFIG_MACH_CP3DUG) || (defined CONFIG_MACH_DUMMY) || (defined CONFIG_MACH_DUMMY) || (defined CONFIG_MACH_DUMMY)))
