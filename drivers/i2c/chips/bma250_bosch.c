		...
		const char *buf, size_t count)
{
	...
	if(enable == 1 && !power_key_pressed){ // Slope interrupt
	    ...
	    cir_flag = 1;
		/*
			BMA250_INT_MODE_SEL__REG(0x21) = 0x01;
			BMA250_INT_ENABLE1_REG(0x16) = 0x03;
			BMA250_EN_INT1_PAD_SLOPE__REG(0x19) = 0x04;
		*/
	    ...
	    while(retry <= 30) {
			...
			if (reg_val & 0x01) { /* Check BMA250_INT_MODE_SEL__REG status */
	    ...
	    while(retry <= 30) {
			...
			if ((reg_val & 0x03) == 0x03) { /* Check BMA250_INT_ENABLE1_REG status */
	    ...
	    while(retry <= 30) {
			...
			if (reg_val & 0x04) { /* Check BMA250_EN_INT1_PAD_SLOPE__REG status */
