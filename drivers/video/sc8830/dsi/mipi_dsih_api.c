...
dsih_error_t mipi_dsih_open(dsih_ctrl_t * instance)
{
    ...
    mipi_dsih_hal_tx_escape_division(instance, 4); //6    //Jessica If DPHY clock=500m --> 3 need to Change to 4
#else
...
#if defined(CONFIG_MACH_CP5DTU) || defined(CONFIG_MACH_CP5DUG) || defined(CONFIG_MACH_CP5DWG)
    mipi_dsih_hal_tx_escape_division(instance, 4); //6 //Jessia If DPHY clock=500m --> 3 need to Change to 4
#else
