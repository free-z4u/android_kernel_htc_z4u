...
//struct msm_bus_scale_pdata *bus_scale_table = NULL; //liushoubin 20130309
 ...
 */
//extern int msm_otg_setclk( int on);//liushoubin modify 20130309
...
int wl_android_wifi_on(struct net_device *dev)
{
  ...
  #endif
	//msm_otg_setclk(1);//liushoubin modify 20130309
	/*HTC_WIFI_END*/
...
int wl_android_wifi_off(struct net_device *dev)
{
	...
	if (bus_perf_client)
       ...
       #endif
 	//msm_otg_setclk(0);//liushoubin modify 20130309
 	/*HTC_WIFI_END*/
	mutex_unlock(&wl_wifionoff_mutex);
	bcm_mdelay(500);
	return ret;
...
int wifi_set_power(int on, unsigned long msec)
{
	...
	/*HTC_WIFI_START*/ //liushoubin 20130309
