...
{
#if !((defined CONFIG_MACH_PROTODCG) || (defined CONFIG_MACH_DUMMY) || (defined CONFIG_MACH_CP3DUG) || (defined CONFIG_MACH_DUMMY) || (defined CONFIG_MACH_DUMMY) || (defined CONFIG_MACH_DUMMY) || (defined CONFIG_MACH_DUMMY) || (defined CONFIG_MACH_Z4U))
