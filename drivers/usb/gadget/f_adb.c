...
/* HTC_KER_START ken, merge form merge from ics-mr1-rel_shep_qct8960_ville-evita-crc */
...
/* HTC_KER_START, ken, merge from ics-mr1-rel_shep_qct8960_ville-evita-crc */
...
/* TODO: move to /kernel/include/linux/usb/htc_info.h if existed */
extern int htc_usb_enable_function(char *name, int ebl); /* HTC_KER_ADD, ken, porting from PYDTD for Tethering */
...
static int adb_enable_open(struct inode *ip, struct file *fp)
{
	...
	htc_usb_enable_function("adb", 1); /* HTC_KER_MOD, ken, porting form ics-mr1-rel_shep_qct8960_ville-evita-crc for Tethering */
...
static int adb_enable_release(struct inode *ip, struct file *fp)
{
	...
	htc_usb_enable_function("adb", 0); /* HTC_KER_MOD, ken, porting form ics-mr1-rel_shep_qct8960_ville-evita-crc for Tethering */
	mutex_unlock(&adb_enable_sem);
	return 0;
}
...
static const struct file_operations adb_enable_fops = {
	...
	.unlocked_ioctl	= adb_enable_ioctl, /* HTC_KER_ADD, ken, merge from ics-mr1-rel_shep_qct8960_ville-evita-crc */
};
...
#if 1 /* HTC_KER_MOD, ken, enable STE phonet function */
	ret = misc_register(&adb_enable_device);
#else /* HTC_KER_START, ken, merge from ics-mr1-rel_shep_qct8960_ville-evita-crc */
...
static void adb_cleanup(void)
{
	...
	misc_deregister(&adb_enable_device); /* HTC_KER_ADD, ken, merge from ics-mr1-rel_shep_qct8960_ville-evita-crc */
