...
enum {
	...
	SMSG_CH_VBC,		/* audio conrol channel for td */
	SMSG_CH_PLAYBACK, 	/* audio playback channel for td */
	SMSG_CH_CAPTURE,	/* audio capture channel for td */
	//HTC_AUD_START add for voip support
	SMSG_CH_CTRL_VOIP,      /* audio conrol channel for voip */
	SMSG_CH_PLAYBACK_VOIP,  /* audio playback channel for voip */
	SMSG_CH_CAPTURE_VOIP,   /* audio capture channel for voip */
	//HTC_AUD_END
